...
///// SITE NAV
// GET NAV for all pages
// Serve the homepage of your site.

// app.get("*", function(request,response){
//   console.log("are you an all call...!");
...
app.get("/articles/:id", function(request,response){
  ...
  var fileContents = fs.readFileSync("./data.json");
  fileContents = JSON.parse(fileContents);
  var articleIndex = request.params.id;
  response.render("articles/show", {articles:fileContents[articleIndex]});
});
...
//   fs.writeFlieSync("./data.json", JSON.stringify(fileContents));
//   response.render("/articles");
// });

app.delete("/articles/:index/destroy", function(request,response){
